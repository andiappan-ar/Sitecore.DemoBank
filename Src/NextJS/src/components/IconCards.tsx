import { NextImage, Link, LinkField, ImageField, Text, Field, withDatasourceCheck } from '@sitecore-jss/sitecore-jss-nextjs';
...
const IconCards = ({ fields }: IconCardsProps): JSX.Element => (
  ...
  <div className="container px-4 px-lg-5">
      ...
      <h2 className="text-center mt-0"><Text field={fields.CardTitle}></Text></h2>
      <hr className="divider" />
              ...
              <div key={Get_uniqueId()} className="col-lg-3 col-md-6">
                  <div className="mt-5 card" >
                      ...
                      <div className="card-body" style={{width:'18rem'}}>
                          <h5 className="card-title"><Text field={card.fields.CardTitle}></Text></h5>
